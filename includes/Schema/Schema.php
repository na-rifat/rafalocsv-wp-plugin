<?php
namespace Rafalocsv\Schema;

use Rafalocsv\Rafalocsv;

class Schema {
    use \Rafalocsv\Traits\Input;
    use \Rafalocsv\Traits\Helper;

    const prefix     = Rafalocsv::domain;
    const data_types = [
    ...
    public function register() {
        ...
        $this->settings = [
            'style'          => [
                ...
                // ],
                // 'link-hover-color'       => [
                //     'label' => __( 'Link hover color', $domain ),
                //     'type'  => 'color',
                //     'value' => '#0a58ca',
                // ],
                'primary-bg-color'       => [
                    'label' => __( 'Primary background color', $domain ),
                    'type'  => 'color',
                ...
                'nav-color'              => [
                    'label' => __( 'Navigation text color', $domain ),
                    'type'  => 'color',
                    'value' => 'rgb(0, 25, 53)',
                ],
                'nav-hover-color'        => [
                    'label' => __( 'Navigation text hover color', $domain ),
                    'type'  => 'color',
                    'value' => 'rgb(103, 221, 118)',
                ],
                'nav-active-color'       => [
                    'label' => __( 'Active menu item color', $domain ),
                    'type'  => 'color',
                    'value' => 'rgb(103, 221, 118)',
                ],
                // 'breadcrumb-bg-color'    => [
                //     'label' => __( 'Breadcrumb background color', $domain ),
                //     'type'  => 'color',
                //     'value' => 'rgb(175, 175, 175)',
                // ],
                // 'breadcrumb-text-color'  => [
                //     'label' => __( 'Breadcrumb text color', $domain ),
                //     'type'  => 'color',
                //     'value' => 'rgb(255, 255, 255)',
                // ],
                'header-logo-text-color' => [
                    'label' => __( 'Header logo text color', $domain ),
                    'type'  => 'color',
                    'value' => 'rgb(0, 0, 0)',
                ],
                'transition'             => [
            ...
            'header'         => [
                ...
                'enable-right-button'    => [
                    'label'   => __( 'Enable right-side button', $domain ),
                    'type'    => 'select',
                    'value'   => 'enabled',
                    'options' => [
                        'enabled'  => __( 'Enabled', $domain ),
                        'disabled' => __( 'Disabled', $domain ),
                    ],
                    'class'   => ['regular-text'],
                ],
                'site-title'             => [
            ...
            'header_buttons' => [
                'button1url'     => [
                    'label' => __( 'Button 1 url', 'rafalocsv' ),
                    'type'  => 'text',
                    'value' => '#',
                ],
                'button2url'     => [
                    'label' => __( 'Button 2 url', 'rafalocsv' ),
                    'type'  => 'text',
                    'value' => '#',
                ],
                'button2text'    => [
                    'label' => __( 'Button 2 text', 'rafalocsv' ),
                    'type'  => 'text',
                    'value' => 'Button',
                ],
                'button2subtext' => [
                    'label' => __( 'Button 2 sub text', 'rafalocsv' ),
                    'type'  => 'text',
                    'value' => 'Button',
                ],
                'button3url'     => [
                    'label' => __( 'Button 3 url', 'rafalocsv' ),
                    'type'  => 'text',
                    'value' => '#',
                ],
                'button3text'    => [
                    'label' => __( 'Button 3 text', 'rafalocsv' ),
                    'type'  => 'text',
                    'value' => 'Button',
                ],
            ],
