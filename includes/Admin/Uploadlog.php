...
class Uploadlog extends \WP_List_Table {
    function __construct( $posts ) {
        $GLOBALS['rafalocsv_import_log'] = $posts;
    ...
    protected function column_default( $item, $column_name ) {
        ...
        switch ( $column_name ) {
            case 'image':
                return "<img class='rafalocsv-imported-thumbnail' src='{$item['img_url']['thumbnail']}' alt='" . __( 'Rafalocsv imported post thumbnail', 'rafalocsv' ) . "' />";
            case 'post_id':
                return $item['ID'];
            case 'title':
    ...
    public function prepare_items() {
        ...
        $this->items = is_object( $GLOBALS['rafalocsv_import_log'] ) ? $GLOBALS['rafalocsv_import_log'] : (object) [];
        $this->items = $GLOBALS['rafalocsv_import_log'];
